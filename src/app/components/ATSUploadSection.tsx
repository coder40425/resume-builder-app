...
{"score":<0-100>,"rating":"<Excellent|Good|Average|Weak>","overview":"<2-3 sentences>","sections":[{"label":"Contact & Header","score":<0-100>,"status":"<strong|average|weak>","comment":"<1 sentence>"},{"label":"Professional Summary","score":<0-100>,"status":"<strong|average|weak>","comment":"<1 sentence>"},{"label":"Work Experience","score":<0-100>,"status":"<strong|average|weak>","comment":"<1 sentence>"},{"label":"Skills & Keywords","score":<0-100>,"status":"<strong|average|weak>","comment":"<1 sentence>"},{"label":"Education","score":<0-100>,"status":"<strong|average|weak>","comment":"<1 sentence>"},{"label":"Formatting & ATS","score":<0-100>,"status":"<strong|average|weak>","comment":"<1 sentence>"}],"strengths":["<s1>","<s2>","<s3>","<s4>"],"improvements":["<i1>","<i2>","<i3>","<i4>"],"keywords":{"found":["<k1>","<k2>","<k3>","<k4>"],"missing":["<k1>","<k2>","<k3>","<k4>"]},"verdict":"<1 bold sentence>"}
